...
2. **Clone this repository.** - `git clone https://github.com/rmonet1203/shopping_cart_mern.git`
3. **Make sure you're in the directory you just created.** - `cd shopping_cart_mern`
